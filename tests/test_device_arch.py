...
from training_musa_adaptor.patches.megatron import device_arch as _device_arch, distributed as _distributed


def test_arch_tuple_is_fixed_at_the_verified_default(monkeypatch):
    """The ARCH env knob is retired in v2.0: any value, any spelling, and
